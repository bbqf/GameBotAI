...
describe('QueuesPage edit layout', () => {
  ...
  it('Save commits only name + cycle execution', async () => {
    ...
    await waitFor(() =>
      expect(updateQueueMock).toHaveBeenCalledWith('q1', { name: 'Daily Renamed', cycleExecution: true, emulatorInstanceName: null, emulatorInstanceIndex: null, resumeOnServiceStart: false })
    );
  });
